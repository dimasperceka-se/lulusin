...
const TRYOUT_TITLE = "Tryout CPNS HOTS 2024";
const TRYOUT_DESCRIPTION = "Latihan SKD HOTS (Higher-Order Thinking Skills) 2024 versi parafrase: 30 TWK + 35 TIU + 45 TKP selama 100 menit.";
const TRYOUT_DURATION_MINUTES = 100;
const TAG_PREFIX = "hots-2024:";

const REPO_ROOT = path.resolve(path.dirname(fileURLToPath(import.meta.url)), "../..");
const XLSX_PATH = path.join(REPO_ROOT, "attached_assets/HOTS_2024_PARAFRASE.xlsx");
...
async function main() {
  ...
  console.log(`  IMPORT HOTS 2024 → "${TRYOUT_TITLE}" (package id=${CPNS_PACKAGE_ID})`);
  console.log("=".repeat(70));

  console.log("\n[0/4] Cleanup previous hots-2024 import (if any)...");
